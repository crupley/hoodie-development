...
Getting to understand the character of a city's neighborhood can be difficult and recognizing where one neighborhood ends and another begins is not easy either, especially considering that character can be continually evolving. I am proposing a tool to visualize functional neighborhoods in a city based on clusters of similar characteristics, not politically drawn boundaries.
...
Once you have determined what metrics you are interested in, you can find other areas of the city that are similar based on those metrics. Or you could even assess neighborhoods in another city you have never visited if you are planning a visit or perhaps relocating there.

Finding similar neighborhoods could be useful to individuals looking to discover new places to vist or move, to businesses trying to reach their target customers, and to municipal governments for planning infrastructure and services.
